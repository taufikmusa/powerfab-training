...
- [Step 15 — Create a cut list](step-15.md)
- [Step 16 — Process the cut list](step-16.md)
- [Step 17 — Production tracking](step-17.md)
- [Step 18 — Create a load and ship](step-18.md)
