...
2. Click **New Template (F1)** and name it — *Structural*, for example.
...
5. Set a **Status Link** tied to a real tracked event — Detailing to *Drawings Approved* (By Quantity), Fabrication to *Station/Production Progress* (By Weight), Shipping to *Shipping Completed* (By Weight).
